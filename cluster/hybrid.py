...
def _hybrid_medoids_update(
    ...
    proposed_center_inds, proposed_assignments, proposed_distances = _kmedoids_update(traj, distance_method, cluster_center_inds, assignments, distances, verbose=verbose)
...
def hybrid(
    ...
    for i in range(n_iters):
        cluster_center_inds, assignments, distances = _hybrid_medoids_update(traj, distance_method, cluster_center_inds, assignments, distances, verbose=verbose)
